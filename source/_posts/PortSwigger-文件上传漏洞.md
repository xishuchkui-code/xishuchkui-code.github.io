...
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774761955771.png)
按前面的所有方法尝试一下，发现都不行，换种方法
- 使用`%00`截断绕过
上传 `shell.php`，抓包
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774765607769.png)
修改其中的
```
Content-Disposition: form-data; name="avatar"; filename="photo1.php%00.png"
Content-Type: image/png
```
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774766441166.png)
访问对应的路径
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774766522088.png)
去主页 `submit solution` 提交



## Lab 6: Remote code execution via polyglot web shell upload
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774768180496.png)
先登录抓包按流程走
正常情况行不通
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774768564477.png)
尝试修改文件名后缀，修改 `Content-Type` 为图片类型 `image/png`
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774768731877.png)
没成功
...
再次进行尝试
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774770312598.png)
成功上传，接下来访问路径 `/files/avatars/shell1.php`
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774770689016.png)
最后面的就是
...
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774771836455.png)
这次就当学习使用 `burp` 了

先登录上传 `shell.php` 抓包，把包发给 `Intruder`
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774772801565.png)
点击攻击，我们访问其 `/files/avatars/shell.php`
![](../img/PortSwigger-文件上传漏洞/PortSwigger-文件上传漏洞-1774772907362.png)
成功了
### 条件竞争文件上传漏洞
